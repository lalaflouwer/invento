...
<div id="container">
<br>
<h1>Profile Information</h1><br><br><br>
	<?php
	session_start();
	...
	$result = mysqli_query($dbc, $sql);
		...
		echo "<tr>";
		echo "<td>".$row[1]."</td> <td>".$row[4]."</td> <td>".$row[5]."</td> <td>".$row[6]." <td>".$row[7]."</td> <td>".$row[8]."</td> <td>".$row[9]."</td> <td>".$row[10]."</td> <td>".$row[11]."</td> <td>".$row[12]."</td>";
		echo "</tr>";		
		}
