...
<h1>Profile Information</h1><br><br>
	...
	echo " <table bgcolor='#8e1106' border= 1 width='70%'>
		...
		echo "<br/>";
		$comma = " ,";
		echo 'Welcome ' .$row[1] .$comma; //Selects and shows the cust's name.
		echo "<br/><br/>";
	
		echo "<tr>";
		echo "<td>".$row[1]."</td> <td>".$row[2]."</td> <td>".$row[3]."</td> <td>".$row[4]." <td>".$row[5]."</td> <td>".$row[6]."</td>";
		?>
		
		<td><a href="customerEdit.php?edit_id=<?php echo $row[0]; ?>" alt="edit" >Edit</a></td>
		<?php
		echo "</tr>";		
		}
