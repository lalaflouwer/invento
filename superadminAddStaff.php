...
<form action="" method="post" name="myForm" onsubmit="return(validate());" enctype="multipart/form-data" >
  ...
  <!-- Disable/Enable fields when user is Singaporean.-->
			...
			<td>Joined Date</td><td>:</td><td><input type="text" name="join"></td>
			</tr>
