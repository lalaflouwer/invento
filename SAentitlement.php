...
?>
		          ...
		          <tr>
				  <td contentEditable align='center' bgcolor='#ffffff' style=color:#000000 width='4%'><?php echo $row["emp_fullname"];?></td>	
			<td contentEditable align='center' bgcolor='#ffffff' style=color:#000000 width='4%'><?php echo $row["med_entitlement"];?></td>	
	<td contentEditable align='center' bgcolor='#ffffff' style=color:#000000 width='6%'><?php echo $row["med_leave"];?></td>			
			<td contentEditable align='center' bgcolor='#ffffff' style=color:#000000 width='6%'><?php echo $row["hosp_leave"];?></td>
