...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js" type="text/javascript"></script>
  ...
  <div id="table">
    <table width="50%" border="0">
	  <tr align="top">
	  <td bgcolor="#8e1106" width="30%"s>
	<ul><br>
		<li><a href="#" style="color:white" >Labratory / Clean Room</a></li>
		<li><a href="projectref2.php" style="color:white"><b><big>Factories / Plants</big></b></a></li>
		<li><a href="projectref3.php" style="color:white">Office/Shops / Showroom</a></li>
	...
	<td width="90%">
      ...
      <div class="imageContainer" id="im_1">
        <img src="ProjectRef/img1.jpeg" height="300px" width="500px"/>
  
      </div>

      <div class="imageContainer" id="im_2">
         <img src="ProjectRef/img2.jpeg"  height="300px" width="500px" />
        
      </div>

      <div class="imageContainer" id="im_3">
          <img src="ProjectRef/img3.jpeg" height="300px" width="500px" />
