...
<div id="container">
<br>
<h1>Career Application</h1><br><br>
<table bgcolor="#8e1106" width="50%">
	 ...
	 <br />
      ...
      function validate()
      {
		 ...
		 if( document.myForm.position.value == "")
          {
            alert( "Please choose your preferred Position!" );
	...
	<?php
		...
		$sql="INSERT INTO `career` (`car_fullname`, `car_gender`, `car_age`, `car_nationality`, `car_position`, `car_salary`, `car_email`, `car_number`, `car_resume`) VALUES ('$fname','$gender','$age','$country','$position','$salary','$email','$number','$resume')";
			
			mysqli_query($dbc, $sql);
			header("Location: addCareer.php");//redirect to addCareer.php page
		mysqli_close( $dbc ) ;
			}
?>
	...
	<form action="" name="myForm" method="POST" enctype="multipart/form-data" onsubmit="return(validate());" >
		...
		<td>
	  <br>Full Name:<br>
	  <input type="text" name="fullname" size="30" placeholder="Enter Full Name"><br><br>
		...
		Age:
			<input type="text" name="age" maxlength="2" size="1"><br><br>
		...
		Position Applying for :
			...
			<option value="HRassist">HR/ACC Assistant</option>
			...
			Expected Salary:
			<input type="text" name="salary" size="7" placeholder="$0.00"><br><br>
	  </td>
	  </th>
	  ...
	  <td>
		<br>Email Address:<br>
			<input type="email" name="email" maxlength="30" size="30"><br><br>
		  
		Contact Number:<br>
			<input type="number" name="number" maxlength="10"><br><br>
