...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js" type="text/javascript"></script>
  ...
  <body>
	...
	<ul>
		...
		<li><a href="projectref5.php"style="color:white" ><b><big>X-ray Room / Clinical</b></big></a></li>
    ...
    <div id="showContainer">
      ...
      <div class="imageContainer" id="im_1">
        <img src="ProjectRef/img15.jpeg" height="300px" width="500px"/>
  
      </div>

      <div class="imageContainer" id="im_2">
         <img src="ProjectRef/img16.jpeg"  height="300px" width="500px" />
