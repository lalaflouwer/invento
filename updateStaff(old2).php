...
?>
<div id="add">
<form action="updateStaff(old2).php" method="post" enctype="multipart/form-data">
...
<th>
	...
	<input type="text" name="empid" maxlength="5" size="1" pattern="[A-Z]{3,5}" required title="Min.3, Max. 5 Capitial Letters ONLY! " value="<?php echo $emp_id;?>" ><input type="submit" name="search" value="Find"><br><br> 
	
	Update Employee Photo:<br>
	<input type="file" name="image" id="image" value="<?php echo $emp_img;?>"><br><br>
	
	Full Name:
	<input type="text" name="fullname" value="<?php echo $emp_fullname;?>"><br><br> 
   
	Email:
	<input type="text" name="email" value="<?php echo $emp_email;?>"><br><br> 

	Contact
    <input type="text" name="contact" value="<?php echo $emp_contact; ?>" ><br><br> 
	
	Home Contact
    <input type="text" name="homeContact" value="<?php echo $emp_homeContact; ?>" ><br><br> 

	<!--Password
	<input type="text" name="password" value="<?php echo $emp_pass; ?>" >-->
	Date of Birth:
...
<th>
   ...
   <td>
	NRIC
    <input type="text" name="nric" value="<?php echo $emp_nric;?>" ><br><br> 
	...
	<br><br> 	
	Race
	<input type="text" name="race" value="<?php echo $emp_race ;?>"><br><br> 	
			
	WP / SP No.
	<input type="text" name="permitNo" value="<?php echo $emp_permitNo ;?>" ><br><br> 
	
	WP / SP Expiry Date
	<input type="text" name="permitExpiry" value="<?php echo $emp_permitExpiry ;?>" ><br><br> 
	
	Fin<br>
	<input type="text" name="fin" value="<?php echo $emp_fin;?>" ><br><br> 
	
	Passport No
	<input type="text" name="passportNo" value="<?php echo $emp_passportNo ;?>" ><br><br> 
	
	Passport Expiry
	<input type="text" name="passportExpiry" value="<?php echo $emp_passportExpiry; ?>"><br><br> 
    ...
    Address
    <input type="text" name="address" maxlength="100" size="30" style="height:50px; width:300px" rows="2" cols="25" value="<?php echo $emp_address;?>"><br><br> 
	
	Postal Code<br>
	<input type="text" name="postal" value="<?php echo $emp_postal; ?>"><br><br> 
	
	Foreign Address
    <input type="text" name="faddress" maxlength="100" size="30" style="height:50px; width:300px" rows="2" cols="25" value="<?php echo $emp_faddress;?>"><br><br> 
	
	Foreign Postal Code
    <input type="text" name="fpostal" value="<?php echo $emp_fpostal; ?>" ><br><br> 
	</td>
	</th>
	<th><td>
	...
	Designation
    <input type="text" name="designation" value="<?php echo $emp_designation; ?>"><br><br> 
	
					Type&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:					
					<input type="radio" name="type" value="Admin" <?php if ($emp_type=='Admin') { echo "checked"; } ?> > Admin
					<input type="radio" name="type" value="Employee" <?php if ($emp_type=='Employee') { echo "checked"; } ?> > Employee<br><br><br> 
					
					
					Status&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:
					<input type="radio" name="status" value="Active" <?php if ($emp_status=='Active') { echo "checked"; } ?> > Active
					<input type="radio" name="status" value="Inactive" <?php if ($emp_status=='Inactive') { echo "checked"; } ?>  >Inactive<br>
				<br><br> <br><br> <br>

    Commencement Date
    <input type="date" name="joined" value="<?php echo $emp_joined; ?>"><br><br> 
