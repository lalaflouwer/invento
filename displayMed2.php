...
<?php echo 'Entitlement : ' .$_SESSION['med_entitlement'].'  ';?><br>
...
<?php
	...
	$sql= "SELECT * FROM medical WHERE emp_id='$_GET[id]'"; //DESC means latest medical ID will be shown first.
	...
	echo " <table cellpadding='8' bgcolor='#000000' style=color:#ffffff width='80%'>
			...
			<th>Balance <br>Hospital Leave<br> ( Days )</th>
			<th>Balance <br> Medical Leave<br> ( Days )</th>
...
?>
		          ...
		          <tr>
			<td align='center' bgcolor='#ffffff' style=color:#000000 width='4%'><?php echo $row["med_id"];?></td>
			<td align='center' bgcolor='#ffffff' style=color:#000000 width='15%'><?php echo $row["med_date"];?></td>
			<td align='center' bgcolor='#ffffff' style=color:#000000 width='15%'><?php echo $row["med_clinic"];?></td>
			<td align='center' bgcolor='#ffffff' style=color:#000000 width='7%'><?php echo $row["med_type"];?></td> 
			<td align='center' bgcolor='#ffffff' style=color:#000000 width='10%'><?php echo $row["med_days"];?></td>
			<td align='center' bgcolor='#ffffff' style=color:#000000 width='4%'><?php echo $row["med_currency"];?></td>
			<td align='center' bgcolor='#ffffff' style=color:#000000 width='5%'><?php echo $row["med_paid"];?></td>
			<td align='center' bgcolor='#ffffff' style=color:#000000 width='4%'><?php echo $row["med_rate"];?></td> 
			<td align='center' bgcolor='#ffffff' style=color:#000000 width='5%'><?php echo $row["med_claimed"];?></td> 
            <td align='center' bgcolor='#ffffff' style=color:#000000 width='6%'><?php echo $row["med_balance"];?></td>			
			<td align='center' bgcolor='#ffffff' style=color:#000000 width='6%'><?php echo $row["hosp_leave"];?></td>
			<td align='center' bgcolor='#ffffff' style=color:#000000 width='6%'><?php echo $row["med_leave"];?></td>
			<td align='left'   bgcolor='#ffffff' style=color:#000000 width='10%'><?php echo $row["med_remark"];?></td>
			</td>
<?php			
            echo "</tr>";
			}     
